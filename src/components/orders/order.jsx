export const Order = (props) => {
  return (
    <div className="overflow-hidden relative w-56 h-64 bg-sky-600 rounded-2xl text-gray-50 flex flex-col justify-evenly items-center gap-2">
      ...
      <span className="font-extrabold text-4xl  -mt-1 mb-5">
        {props.total}$
      </span>
